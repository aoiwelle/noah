...
1. Delete the playbooks directory if it exists:
   ```bash
   rm -rf ~/Library/Application\ Support/com.itman.app/playbooks/
   ```
2. Launch the dev app: `cd apps/desktop && npm run tauri dev`
3. Check the directory was created:
   ```bash
   ls -la ~/Library/Application\ Support/com.itman.app/playbooks/
   ```
...
1. Create a custom playbook:
   ```bash
   cat > ~/Library/Application\ Support/com.itman.app/playbooks/test-playbook.md << 'PLAYBOOK'
   ---
   name: test-custom
...
1. Edit a built-in playbook:
   ```bash
   echo "CUSTOM EDIT" >> ~/Library/Application\ Support/com.itman.app/playbooks/network-diagnostics.md
   ```
2. Restart the app
3. Check the file:
   ```bash
   tail -1 ~/Library/Application\ Support/com.itman.app/playbooks/network-diagnostics.md
   ```
...
```bash
rm ~/Library/Application\ Support/com.itman.app/playbooks/test-playbook.md
```
